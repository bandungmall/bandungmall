...
@section('content')
  ...
  <div class="content"> 
    ...
    <!--======= SUB BANNER =========-->
    <section class="category sub-banner animate" data-wow-delay="0.4s" style="border:0 none !important;">
      <div class="container">
    ...
    <section class="section-p-30px pages-in">
      <div class="container">
        <div class="row"> 
          ...
          <!--======= ITEMS =========-->
          <div class="col-sm-9 animate" data-wow-delay="0.2s">
            <div class="items-short-type animate" data-wow-delay="0.4s"> 
              ...
              <div class="grid-list"> 
                ...
                ?>
                <a href="product/{{$url[2]}}" style="padding-top: 7px;"><i class="fa fa-th-large grid-view" title="Grid"></i></a> 
<!--                <a href="product-list/{{$url[2]}}" style="padding-top: 7px;"><i class="fa fa-th-list list-view" title="List"></i></a> -->
              </div>
            ...
            <!--======= Products =========-->
            <div class="popurlar_product product-column">
              @if($products->isEmpty())
              ...
              <ul class="row">
                ...
                <!-- New Products -->
                <li class="col-sm-4 animate" data-wow-delay="0.4s">
                  <div class="items-in"> 
                    ...
                    <!-- Image --> 
                    <a href="productDetail/{{$product->id}}"><img src="{{$product->image_link }}" alt=""></a>
                    <!-- Hover Details -->
                    ...
                    <div class="details-sec"> 
                      ...
                      <div style="display:none;">{{ $product->brand }}</div>
                      @if($product->discount > 0 && strtotime(date('Y-m-d')) >= strtotime($product->discount_date_start)  && strtotime(date('Y-m-d')) <= strtotime($product->discount_date_end))
