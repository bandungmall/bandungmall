...
<div class="box box-info">
  ...
  <!-- form start -->
  <form class="form-horizontal" action="{{ URL::to('merchant/doUpdateAddressInformation') }}" method="POST">
    ...
    <div class="box-body">
      ...
      <div class="form-group">
        ...
        <div class="col-sm-9">
        <!-- <select class="form-control" name="city" id="kota" style="text-transform: capitalize;">
