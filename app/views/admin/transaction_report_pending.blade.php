        ...
        <div class="box box-success">
          ...
          <div class="box-body">
            <div style="margin-bottom:10px;">
                    ...
                    @endif
                    <form action="{{URL::to('admin/filterTransactionReportPending')}}" method="get">
						<div class="col-lg-6">
		        		...
		        		<a style="margin-top:20px;" class="btn btn-danger" href="{{URL::to('admin/transactionReportPending')}}"><i class="fa fa-remove"></i>&nbsp;&nbsp;&nbsp;Clear Filter</a>
	        		</form>
	        	</div>
          </div><!-- /.box-body -->
        </div>
    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="box box-info">
          <div class="box-header">
            <h3 class="box-title">List Laporan Pending</h3>
          </div><!-- /.box-header -->
          <div class="box-body">
              ...
              <?php $comTotal=0;?>
	                    @foreach($transactions as $transaction)
		                    <tr>
		                        ...
		                        <td><a href="{{URL::to('admin/transaction/transactionSentDetail/'.$transaction->tid)}}"><span class="glyphicon glyphicon-file"></span></td></a>
		                    </tr>
...
@section('javascript')
   ...
   $(function(){
    ...
    $("#menu_report_pending").closest("li").addClass("active");
