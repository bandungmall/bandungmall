                      ...
                      <table width="200" border="0" class="table table-condensed table-bordered">
                        ...
                        @endforeach
                          <tr>
                              <th>Approve</th>
                              <td>
                                @if($detail->is_counted =='pending' && $detail->is_accepted !='pending')
                                  <td><a href="#" onclick="confirmation('../doApproveTransactionDetail?id=<?php echo $detail->id; ?>');"><span class="glyphicon glyphicon-ok"></span></a></td>
                                  <td><a href="#" onclick="confirmation('../doRejectTransactionDetail?id=<?php echo $detail->id; ?>');"><span class="glyphicon glyphicon-remove"></span></a></td>
                                @else
                                  <td colspan="2">{{$detail->is_counted}}</td>
                                @endif
                              </td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            ...
                            @if($detail->is_counted =='pending')
                              <th><a href="#" onclick="confirmation('doApproveTransactionDetail?id=<?php echo $detail->transaction_id.'&merchant_id='.$merchant->merchant_id; ?>');"><span class="glyphicon glyphicon-ok"></span></a></th>
                              <th><a href="#" onclick="confirmation('doRejectTransactionDetail?id=<?php echo $detail->transaction_id.'&merchant_id='.$merchant->merchant_id; ?>');"><span class="glyphicon glyphicon-remove"></span></a></th>
                            @else
                              <th>{{$detail->is_counted}}</th>
                            @endif
                          </tr>
                        -->
                      </table>
...
@section('javascript')
   ...
   $(function(){
    ...
    $("#menu_transaction #menu_transaction_success").addClass("active");
