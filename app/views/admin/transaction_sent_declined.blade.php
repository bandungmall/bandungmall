          ...
          <div class="box-body">
            <div style="margin-bottom:10px;">
                @if (Session::has('error_code'))
                    ...
                    @endif
              <form action="{{URL::to('admin/transaction/filterTransactionPaid')}}" method="get">
            <div class="col-lg-6">
            ...
            <div class="col-lg-6">
              <div class="input-group">
                ...
                <a style="margin-top:20px;" class="btn btn-danger" href="{{URL::to('admin/transaction/transactionPaid')}}"><i class="fa fa-remove"></i>&nbsp;&nbsp;&nbsp;Clear Filter</a>
              </form>
    ...
    <div class="row">
      <div class="col-xs-12">
        <div class="box box-info">
          <div class="box-header">
            <h3 class="box-title">List Transaksi Telah Dibayar</h3>
          </div><!-- /.box-header -->
          <div class="box-body">
            <table id="listTransaction" class="table table-bordered table-hover">
              ...
              @foreach($transactions as $transaction)
                ...
                <td>{{$transaction->td_is_accepted}}</td>
                <td>{{$transaction->sent_status}}</td>
                <td>{{ date_format(new datetime($transaction->created_at), 'g:ia jS F Y') }}</td>
                <td>{{ date_format(new datetime($transaction->batas_pengiriman), 'g:ia jS F Y') }}</td>
                <td><a href="{{URL::to('admin/transaction/transactionSentDetail/'.$transaction->id)}}"><span class="glyphicon glyphicon-file"></span></td></a>
...
@section('javascript')
   ...
   $(function(){
    ...
    $("#menu_transaction_declined").closest("li").addClass("active");
